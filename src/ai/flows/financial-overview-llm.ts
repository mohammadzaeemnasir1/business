...
const financialOverviewPrompt = ai.definePrompt({
  ...
  prompt: `You are a financial analyst providing insights into the financial health of FancyPearls, a cloth shop.
